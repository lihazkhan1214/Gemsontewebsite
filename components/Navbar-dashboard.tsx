...
const DNavbar = () => {
  ...
  return (
    <nav className="bg-[relative] text-white py-4 px-8 border-b-[1px] boreder-[#ccccc] flex justify-between items-center">
      {/* Logo on the left */}
      <div className={`flex items-center gap-10`}>
          ...
          {toogle ?
            <div className="absolute top-0 left-0 h-full w-[300px] z-[80] ">
