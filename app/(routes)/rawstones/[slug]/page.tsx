            ...
            <div className="flex flex-col md:h-[450px] scroll-smooth bg-[#F5F5F5] md:flex-row my-10 justify-center items-center">
              ...
              <div className="flex flex-1 h-full justify-end items-end relative">
                ...
                <div className="absolute bottom-6 left-0 w-full flex  md:flex-wrap justify-center items-center gap-3">
                  <button
                    className={`flex w-[120px] h-[50px]  justify-center hover:bg-[#8e8e8f] items-center py-3 px-6 rounded-sm border border-white text-sm font-[400] text-[#FFF] ${blogDetail.selectedImageType === 'polished' ? 'bg-[#503030]' : 'bg-[#503030] opacity-50'
                      }`}
                  ...
                  <button
                    className={`flex w-[120px] h-[50px] hover:bg-[#8e8e8f]  justify-center items-center py-3 px-6 rounded-sm text-sm font-[400] text-[#FFF] ${blogDetail.selectedImageType === 'rough' ? 'bg-[#503030]' : 'bg-[#503030] opacity-50'
                      }`}
                  ...
                  <button
                    className={`flex w-[120px] h-[50px] hover:bg-[#8e8e8f]  justify-center items-center py-3 px-6 rounded-sm text-sm font-[400] text-[#FFF] ${blogDetail.selectedImageType === 'jewelry' ? 'bg-[#503030]' : 'bg-[#503030] opacity-50'
                      }`}
